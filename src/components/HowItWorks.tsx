                ...
                <div className="space-y-6 sm:space-y-8">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-ac-text-light text-sm sm:text-base">Providers can store and manage all of their credentials in one place â€” including IDs, state licenses, board certifications, diplomas, case logs, ACLS, BLS, PALS, DEA, malpractice insurance, immunizations, TB, NPI number, resumes, references, work and education history, and more.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-ac-text-light text-sm sm:text-base">Providers can connect with their employer and share their full credential packet in seconds â€” or instantly send a PDF or encrypted file to any destination.</p>
                    </div>
                  </div>
                ...
                <div className="space-y-6 sm:space-y-8">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-ac-text-light text-sm sm:text-base">Providers submit reimbursement requests through the app and can track approvals, allowances, and remaining balances â€” reducing HR follow-up and manual communication.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-ac-text-light text-sm sm:text-base">Providers receive automatic alerts before licenses, certifications, or other required documents expire â€” helping prevent delays, gaps, or compliance issues.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-ac-text-light text-sm sm:text-base">Providers can complete forms and sign agreements directly in the app using built-in e-signature â€” eliminating printing, scanning, emailing, and paperwork choke points.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 sm:mt-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              <div className="group bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 sm:rounded-2xl sm:p-8">
                ...
                <p className="text-ac-text-light leading-relaxed text-sm sm:text-base">All provider credentials â€” licenses, diplomas, DEA, immunizations, malpractice, references, education, work history â€” stored in one secure platform instead of scattered across inboxes and folders.</p>
              </div>
              ...
              <div className="group bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 sm:rounded-2xl sm:p-8">
                ...
                <p className="text-ac-text-light leading-relaxed text-sm sm:text-base">Send onboarding packets that automatically auto-populate with the provider's stored documents â€” eliminating repetitive re-requests and manual packet assembly.</p>
              </div>
              ...
              <div className="group bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 sm:rounded-2xl sm:p-8">
                ...
                <p className="text-ac-text-light leading-relaxed text-sm sm:text-base">Automatic reminders for upcoming expirations â€” licenses, certifications, immunizations, malpractice â€” so your team stays ahead, not behind.</p>
              </div>
              ...
              <div className="group bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 sm:rounded-2xl sm:p-8">
                ...
                <h3 className="text-lg font-bold text-ac-text mb-3 sm:text-xl sm:mb-4">Less Admin Work â€” More Capacity</h3>
